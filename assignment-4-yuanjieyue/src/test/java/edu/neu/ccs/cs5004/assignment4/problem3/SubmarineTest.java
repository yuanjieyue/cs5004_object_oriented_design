...
public class SubmarineTest {
  ...
  public void setUp() throws Exception {
    ...
    ship2 = new Submarine(size2, numberOfHitCells1);
    ship3 = new Submarine(size1, numberOfHitCells2);
    sameRefShip = ship1;
    sameAsStateShip = new Submarine(size1, numberOfHitCells1);
    yetAnotherShip = new Submarine(size1, numberOfHitCells1);
  }

  @Test
  public void testToString() {
    String tempStr = new String("Submarine{size=1, numberOfHitCells=0}");
